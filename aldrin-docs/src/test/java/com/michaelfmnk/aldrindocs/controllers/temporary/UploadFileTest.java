package com.michaelfmnk.aldrindocs.controllers.temporary;
...
public class UploadFileTest extends BaseTest {
    ...
    public void shouldUploadFile() throws IOException {
        ...
        String json = given()
                ...
                .when()
                .header(RIGHT_HEADER)
                .post("/aldrin-docs-api/temporary")
                .then()
    ...
    public void shouldFailUploadWithLongNameFile() throws IOException {
        ...
        given()
                ...
                .body("dev_message", Matchers.equalTo("com.michaelfmnk.aldrindocs.exceptions.BadRequestException"));
